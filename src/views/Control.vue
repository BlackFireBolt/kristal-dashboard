                ...
                >
                  ...
                  <v-card>
                    <v-toolbar dark color="primary">
                      ...
                      <v-toolbar-title>Информация со счетчиков</v-toolbar-title>
                    </v-toolbar>
                    <v-card-text>
                      <div v-if="lineData.info" class="mt-5">
                        <v-subheader>
                      ...
                      <p v-else class="mt-5">Нет данных со счетчиков</p>
...
export default {
  ...
  data() {
    return {
      ...
      pickMenu: false,
      bidLog: null,
      dateLog: (new Date(Date.now() - (new Date()).getTimezoneOffset() * 60000)).toISOString().substr(0, 10),
      loadingBtn: false,
      chartTimeout: null,
      form: {
        validate: false,
